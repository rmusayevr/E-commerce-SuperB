...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price_review', models.IntegerField(choices=[(5, '100'), (4, '80'), (2, '40'), (1, '20'), (3, '60')])),
                ('value_review', models.IntegerField(choices=[(5, '100'), (4, '80'), (2, '40'), (1, '20'), (3, '60')])),
                ('quality_review', models.IntegerField(choices=[(5, '100'), (4, '80'), (2, '40'), (1, '20'), (3, '60')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_images', to='Product.product_version')),
            ],
            options={
